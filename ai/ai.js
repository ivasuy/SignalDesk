  ...
  try {
    ...
    try {
      ...
      if (upperResult.startsWith('YES:')) {
        ...
        const normalizedCategory = categoryMap[category.toUpperCase()] || category.toLowerCase();
        return {
          valid: true,
          category: normalizedCategory,
          opportunityScore: 60,
...
//       return parsed;
//     } catch (error) {
//       logError(`Collab parse error: ${error.message}`, {
//         platform: 'ai',
//         stage: 'collab_parsing',
//         action: 'fallback'
//       });
//       return {
...
//     }
//   } catch (error) {
//     logError(`Collab error: ${error.message}`, {
//       platform: 'ai',
//       stage: 'collab_evaluation',
//       action: 'skip'
//     });
//     return {
//       collaboration_fit: false,
//       collaboration_type: 'technical partner',
//       why_you_are_a_fit: `Error: ${error.message}`,
//       suggested_outreach: '',
//       confidence_score: 0
//     };
//   }
...
//       return parsed;
//     } catch (error) {
//       logError(`Buildable parse error: ${error.message}`, {
//         platform: 'ai',
//         stage: 'buildable_parsing',
//         action: 'fallback'
//       });
//       return {
...
//     }
//   } catch (error) {
//     logError(`Buildable error: ${error.message}`, {
//       platform: 'ai',
//       stage: 'buildable_evaluation',
//       action: 'skip'
//     });
//     return {
//       buildable_in_2_days: false,
